 ...
 * @see {@link https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-lifecyclehook.html}
 */
export type AutoScalingLifecycleHookProperties = {
  /**
...
export class AutoScalingLifecycleHook extends $Resource<
  ...
  AutoScalingLifecycleHookProperties,
  Record<string, never>
> {
